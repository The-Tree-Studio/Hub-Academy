...
const FICHES = [
  ...
  },
  {
    ...
    aretenir: "Le responsable Compliance est le référent AML d'i-Hub. Mais la conformité est l'affaire de tous — chaque employé est responsable de ce qu'il observe.",
  },
]
