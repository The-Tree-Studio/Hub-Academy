...
const FICHES_FR = [
  ...
  },
  {
    ...
    "contenu": [
      ...
      {
        "icon": "🏛️",
        "texte": "i-Hub déclare chaque année à l'**ACD** (Administration des Contributions Directes) du Luxembourg"
      },
      {
        "icon": "🔄",
  ...
  },
  {
    ...
    "contenu": [
      ...
      {
        "icon": "📋",
        "texte": "i-Hub doit **conserver et déclarer** le NIF de chaque titulaire de compte déclarable à l’ACD"
      }
    ],
  ...
  },
  {
    ...
    "aretenir": "La classification CRS d’une entité détermine ce qu’i-Hub doit collecter et déclarer. ENF Passive = vigilance accrue."
  },
  {
    "id": 9,
    "emoji": "📊",
  ...
  },
  {
    ...
    "contenu": [
      ...
      {
        "icon": "🔄",
        "texte": "La liste des pays participants est **mise à jour régulièrement** — i-Hub doit surveiller les adhésions nouvelles"
      },
      {
        "icon": "📋",
...
const FICHES_EN = [
  ...
  },
  {
    ...
    "contenu": [
      ...
      {
        "icon": "🏛️",
        "texte": "i-Hub reports annually to the **ACD** (Administration des Contributions Directes) in Luxembourg"
      },
      {
        "icon": "🔄",
  ...
  },
  {
    ...
    "aretenir": "CRS entity classification determines what i-Hub must collect and report. Passive NFE = enhanced scrutiny."
  },
  {
    "id": 9,
    "emoji": "📊",
  ...
  },
  {
    ...
    "contenu": [
      ...
      {
        "icon": "🔄",
        "texte": "The list of participating countries is **updated regularly** — i-Hub must monitor new additions"
      },
      {
        "icon": "📋",
