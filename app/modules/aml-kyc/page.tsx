...
export default function ModuleAmlKyc() {
  ...
  const base:React.CSSProperties={minHeight:'100vh',background:'#f3f4f6',fontFamily:"'Segoe UI',system-ui,sans-serif",color:'#111827'}
  ...
  if (phase==='intro') return (
    <div style={base}><NavBar/>
      <div style={{maxWidth:'680px',margin:'0 auto',padding:'60px 24px',textAlign:'center'}}>
        ...
        <h1 style={{fontSize:'32px',fontWeight:'800',color:'#111827',marginBottom:'12px'}}>{t.title}</h1>
        <p style={{fontSize:'18px',color:'#6b7280',marginBottom:'32px'}}>{t.subtitle}</p>
        ...
        <div style={{display:'flex',gap:'12px',justifyContent:'center',marginBottom:'32px',flexWrap:'wrap'}}>
          {[{label:t.fiches,icon:'📖'},{label:t.quiz,icon:'🎮'},{label:t.time,icon:'⏱️'}].map((b,i)=>(
            <div key={i} style={{background:'white',border:'1px solid #e5e7eb',borderRadius:'12px',padding:'10px 20px',fontSize:'14px',color:'#6b7280',display:'flex',alignItems:'center',gap:'6px'}}>{b.icon} {b.label}</div>
          ))}
        </div>
      ...
      <div style={base}><NavBar/>
        <div style={{maxWidth:'680px',margin:'0 auto',padding:'40px 24px'}}>
          <div style={{textAlign:'center',marginBottom:'28px'}}>
            ...
            <h2 style={{fontSize:'22px',fontWeight:'800',color:'#111827',margin:'0 0 8px'}}>{t.quiz1title}</h2>
      ...
      <div style={base}><NavBar/>
        <div style={{maxWidth:'680px',margin:'0 auto',padding:'40px 24px'}}>
          <div style={{textAlign:'center',marginBottom:'28px'}}>
            ...
            <h2 style={{fontSize:'22px',fontWeight:'800',color:'#111827',margin:'0 0 8px'}}>{t.quiz2title}</h2>
            <p style={{color:'#6b7280',fontSize:'14px',margin:0}}>{activeScenario.scenario}</p>
          </div>
          <div style={{background:'white',border:'2px dashed #0891b240',borderRadius:'16px',padding:'20px',marginBottom:'20px',minHeight:'100px'}}>
            <p style={{fontSize:'12px',fontWeight:'700',color:'#6b7280',textTransform:'uppercase',letterSpacing:'1px',marginBottom:'12px'}}>{t.quiz2folder}</p>
            {briquesPlacees.length===0?<p style={{color:'#6b7280',textAlign:'center',fontSize:'14px',padding:'16px 0'}}>{t.quiz2empty}</p>:
              <div style={{display:'flex',flexDirection:'column',gap:'8px'}}>
          ...
          {briquesDisponibles.length>0&&(
            <div>
              <p style={{fontSize:'12px',fontWeight:'700',color:'#6b7280',textTransform:'uppercase',letterSpacing:'1px',marginBottom:'12px'}}>{t.quiz2available}</p>
      ...
      <div style={{...base,transition:'background 0.3s',background:vfAnimation==='correct'?'#d1fae5':vfAnimation==='wrong'?'#fee2e2':'#f3f4f6'}}><NavBar/>
        ...
        <div style={{maxWidth:'560px',margin:'0 auto',padding:'40px 24px',textAlign:'center'}}>
          ...
          <div style={{background:'white',borderRadius:'20px',padding:'32px 24px',boxShadow:'0 8px 32px rgba(0,0,0,0.08)',marginBottom:'28px',minHeight:'100px',display:'flex',alignItems:'center',justifyContent:'center'}}>
            <p style={{fontSize:'19px',fontWeight:'700',color:'#111827',lineHeight:1.5,margin:0}}>{q.texte}</p>
          </div>
          {vfRepondu===null?(
  ...
  return (
    <div style={base}><NavBar/>
      <div style={{maxWidth:'560px',margin:'0 auto',padding:'60px 24px',textAlign:'center'}}>
        ...
        <h2 style={{fontSize:'32px',fontWeight:'800',color:'#111827',margin:'0 0 8px'}}>{msg}</h2>
        <p style={{color:'#6b7280',fontSize:'16px',marginBottom:'32px'}}>{t.resultTitle}</p>
