// This script writes app/page.tsx
const fs = require('fs');
...
console.log('OK! Dashboard écrit -', tsx.length, 'chars')
console.log('Cohérence:', tsx.includes('coherence-documents'))
console.log('Fraudes:', tsx.includes('fraudes-documents'))
